...
def do_deathmatch(fighter1, fighter2, bet=None):
    ...
    fighter1_turn_replace_list = [":arrow_right:", fighter1name, fighter2name,
                                  ac.read_account(fighter1.id, key=ac.SPECIAL_MOVE_KEY)]
    fighter2_turn_replace_list = [":arrow_left:", fighter2name, fighter1name,
                                  ac.read_account(fighter2.id, key=ac.SPECIAL_MOVE_KEY)]
